...
### Handler function
A handler is a function similar to a [middleware](https://expressjs.com/en/guide/using-middleware.html) in express. The following statement also true for controller-chain handlers:
